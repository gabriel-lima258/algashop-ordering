...
import com.gtech.algashop.core.application.customer.query.*;
...
import com.gtech.algashop.core.domain.model.costumer.CustomerArchivedException;
...
class CustomerControllerContractTest {
    ...
    @MockitoBean
    private ForQueryShoppingCarts shoppingCartQueryService;
    ...
    void updateCustomerContract() {
        ...
        Mockito.when(customerQueryService.findById(customerId)).thenReturn(customerOutput);
    ...
    void deleteCustomerContract() {
        ...
        Mockito.doNothing().when(customerManagementApplicationService).archive(customerId);
    ...
    void deleteCustomerError422Contract() {
        ...
        Mockito.doThrow(CustomerArchivedException.class).when(customerManagementApplicationService)
                .archive(customerId);
    ...
    void deleteCustomerError500Contract() {
        ...
        Mockito.doThrow(RuntimeException.class).when(customerManagementApplicationService)
                .archive(customerId);
