...
public class ShoppingCartPersistenceEntityAssembler {
    ...
    /**
     * Cria uma nova com.gtech.algashop.infrastructure.adapters.out.persistence.shoppingcart.ShoppingCartPersistenceEntity a partir de um ShoppingCart de domínio.
     * Delega para merge() evitando duplicação de lógica de mapeamento.
     *
     * Usado pelo repositório no fluxo de INSERT:
     *   ShoppingCart (domínio) → com.gtech.algashop.infrastructure.adapters.out.persistence.shoppingcart.ShoppingCartPersistenceEntity (nova) → JPA salva no banco
     */
