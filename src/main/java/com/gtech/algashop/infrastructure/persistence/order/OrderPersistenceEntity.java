...
public class OrderPersistenceEntity {
    ...
    // devemos sobreescrever nomes de atributos para evitar duplicação de criação em tabelas, isso previne e
    // define melhor qual objeto usa essa classe composta
    @Embedded
    @AttributeOverrides({
